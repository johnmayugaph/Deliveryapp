      ...
      <header className="sticky top-0 z-10 border-b border-black/10 bg-surface/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-5 gap-y-2 px-5 py-3">
          ...
          <nav className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[13px] font-medium">
            ...
            <Link href="/admin/areas" className="hover:text-brand-700">
              Areas
            </Link>
            <Link href="/admin/stores" className="hover:text-brand-700">
              Stores
            </Link>
            ...
            <Link href="/admin/settlement" className="hover:text-brand-700">
              Settlement
            </Link>
            <Link href="/admin/subscriptions" className="hover:text-brand-700">
              Plus
            </Link>
            <Link href="/admin/surge" className="hover:text-brand-700">
              Surge
            </Link>
            <Link href="/admin/referrals" className="hover:text-brand-700">
              Referrals
            </Link>
            <Link href="/admin/loyalty" className="hover:text-brand-700">
              Points
            </Link>
